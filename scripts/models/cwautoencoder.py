...
from scripts.analysis_utils import get_CosineDistance_matrix, aggregate_metric_from_specimen_to_species
...
class CWmodelVQGAN(VQModel):
    ...
    def test_epoch_end(self, in_out):
        ...
        plot_heatmap(z_cosine_distances.cpu(), '/home/mridul/phylonn/paper_plots/', title='Cosine_distances_tinker', postfix='test_data_infer_model')
        ...
        plot_heatmap(z_cosine_distances_avg_over_classes.cpu(), '/home/mridul/phylonn/paper_plots', title='Cosine_distances_aggregated_tinker', postfix='test_data_infer_model')
