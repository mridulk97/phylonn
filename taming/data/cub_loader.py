...
class CUB_Dataset(Dataset):
    def __init__(self, type_, params, normalizer=None, verbose=False):
        ...
        self.filenames = [x[0] for x in self.dataset.imgs]
    ...
    def getTransforms(self):
        ...
        if self.augmentation_enabled:
            transformsList = transformsList + [
                transforms.CenterCrop(size=(self.imageDimension, self.imageDimension)),
...
class datasetManager:
    ...
    def getLoaders(self):
        ...
        self.train_loader = torch.utils.data.DataLoader(self.dataset_train, batch_size=batchSize)
