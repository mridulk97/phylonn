...
def main():
    ...
    args.input = r'/fastscratch/mridul/cub_190_split_resized/official/CUB_200_2011/train_segmented_imagenet_background'
    args.output = r'/fastscratch/mridul/cub_190_split_resized/official/CUB_200_2011/train_segmented_imagenet_background_bb_crop'

    
    if not args.bbox:
        bboxfile = '/fastscratch/mridul/cub_190_split_resized/official/CUB_200_2011/bounding_boxes.txt'
    else:
        bboxfile = args.bbox

    if not args.index:
        indexfile = '/fastscratch/mridul/cub_190_split_resized/official/CUB_200_2011/images.txt'
    else:
    ...
    for path, subdirs,files in os.walk(args.input):
        for name in files:
            ...
            savefileto=os.path.join(args.output, os.path.basename(path), name)
