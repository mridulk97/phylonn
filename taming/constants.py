...
DISENTANGLER_ANTI_MAPPING_OUTPUT = 'anti_classification_mapping_output'
DISENTANGLER_ANTI_LEARNING_OUTPUT = 'anti_classification_learning_output'
NON_CLASS_TENSORS = [DISENTANGLER_ANTI_LEARNING_OUTPUT, DISENTANGLER_ANTI_MAPPING_OUTPUT, DISENTANGLER_ENCODER_INPUT, DISENTANGLER_DECODER_OUTPUT, QUANTIZED_PHYLO_OUTPUT, DISENTANGLER_NON_ATTRIBUTE_TO_ATTRIBUTE_OUTPUT, QUANTIZED_PHYLO_NONATTRIBUTE_OUTPUT, DISENTANGLER_NON_ATTRIBUTE_CLASS_OUTPUT]
