...
class PhyloVQVAE(VQModel):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log("train/base_hypothetical_rec_loss", hypothetical_rec_loss, prog_bar=True, logger=True, on_step=True, on_epoch=True)
        self.log("train/base_hypothetical_quantizer_loss", base_hypothetical_quantizer_loss, prog_bar=True, logger=True, on_step=True, on_epoch=True)
        self.log("train/base_true_rec_loss", true_rec_loss, prog_bar=True, logger=True, on_step=True, on_epoch=True)
        self.log("train/base_quantizer_loss", base_quantizer_loss, prog_bar=True, logger=True, on_step=True, on_epoch=True)
