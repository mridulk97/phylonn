...
python main.py --name CUB-PhyloNN --postfix 128_codes_seg_white_aug_conv_150_phylochannels_dropout --base configs/phyloNN_256_codes.yaml -t True --gpus 0,1,2,3,
