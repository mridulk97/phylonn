...
# python main.py --name Phylo-VQVAE --postfix 256img-phase5-4cbperlevel-higherlr --base configs/custom_vqgan-256emb-512img-phylo-vqvae-phase5-4cbperlevel-higherlr.yaml -t True --gpus 0, 

# python main.py --name Phylo-VQVAE --postfix 256img-phase5-nolastrelumlp --base configs/custom_vqgan-256emb-256img-phylo-vqvae-phase4-8cbperlevel-lowerlr-stronganti-1hiddenlayer-nolastrelumlp.yaml -t True --gpus 0, 
...
# python main.py --prefix /fastscratch/elhamod --name Phylo-VQVAE --postfix 512img-phase5-lowerbetaclassification --base configs/custom_vqgan-256emb-256img-phylo-vqvae-phase5-evenlargerbatch-lowbetaclassification.yaml -t True --gpus 0, 

# python main.py --prefix /fastscratch/elhamod --name Phylo-VQVAE --postfix 512img-phase5-lowercbweight --base configs/custom_vqgan-256emb-256img-phylo-vqvae-phase4-8cbperlevel-lowerlr-stronganti-1hiddenlayer-nolastrelumlp-lowercbweight.yaml -t True --gpus 0, 

python main.py --prefix /fastscratch/elhamod --name Phylo-VQVAE --postfix 512img-phase5-smallercb --base configs/custom_vqgan-256emb-256img-phylo-vqvae-phase4-8cbperlevel-lowerlr-stronganti-1hiddenlayer-nolastrelumlp-smallercb.yaml -t True --gpus 0, 
