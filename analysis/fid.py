...
if __name__ == "__main__":
    ...
    species = []
    fids = []
    for specie in glob.glob(os.path.join(options.path1, "*")):
        species_class = specie.split('/')[-1]
        species.append(species_class)
        path1 = os.path.join(options.path1, species_class)
        path2 = os.path.join(options.path2, species_class)
